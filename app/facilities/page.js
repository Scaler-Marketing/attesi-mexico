  ...
  return (
    <>
      ...
      <main>
        ...
        {facilities.length > 0 && (
          <section className="fac-carousel section" id="fac-carousel">
            <div className="container">
              <div className="experiences__header">
                <div className="experiences__header-left">
                  <h2 className="experiences__title">Our Facilities</h2>
                  <p className="experiences__subtitle">
                    From sacred study spaces to working gardens — every corner of Attesi has a story.
                  </p>
                </div>
                <div className="experiences__arrows">
                  <button className="carousel-arrow fac-carousel-prev" aria-label="Previous facility">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path d="M12.5 15L7.5 10L12.5 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
                  <button className="carousel-arrow fac-carousel-next" aria-label="Next facility">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <div className="experiences__track-wrapper">
                <div className="experiences__track fac-carousel-track">
                  {facilities.map((fac) => {
                    ...
                    return (
                      <article key={fac._id + "-carousel"} className="exp-card">
                        ...
                        <div className="exp-card__body">
                          ...
                          <Link href={`/facilities/${fac.slug}`} className="btn-primary btn--sm">
                            Explore
                          </Link>
                        </div>
                      </article>
              ...
              <div className="experiences__progress fac-carousel-progress">
