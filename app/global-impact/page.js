    ...
    <>
      ...
      <section className="gi-hero">
        ...
        <div className="gi-hero__content container">
          <span className="gi-hero__eyebrow">Our Commitment</span>
          <h1 className="gi-hero__title">Rooted in the Land</h1>
        ...
        <div className="container gi-intro__inner">
          <div className="gi-intro__text-col">
            <p className="gi-intro__lead">
              Attesi is built on a deep commitment to sustainability, community, and care for the earth.
              Every decision — from how we grow to how we live — is guided by a belief that we are not
              separate from nature, but part of it.
            </p>
          </div>
      ...
      <section className="gi-philosophy section gi-philosophy--alt">
        <div className="container gi-philosophy__inner">
          <div className="gi-philosophy__content">
            <span className="gi-section-eyebrow">Philosophy & Approach</span>
            <h2 className="gi-section-title">Not maintenance. Participation.</h2>
      ...
      <section className="gi-practices section">
        <div className="container">
          <span className="gi-section-eyebrow">Our Practices</span>
          <h2 className="gi-section-title">Closed-loop systems that honor natural cycles.</h2>
          <p className="gi-section-body gi-section-body--wide">
            From composting systems that return nutrients back to the soil, to mindful land
            stewardship, every element is designed to give back more than it takes.
          </p>
      ...
      <section className="gi-vision section">
        <div className="container gi-vision__inner">
          <span className="gi-section-eyebrow">Our Vision</span>
